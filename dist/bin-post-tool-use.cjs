...
var DEFAULT_FIRE_THRESHOLD = 0.4;
...
function openDb(path5) {
  const db = new DatabaseSyncCtor(path5, { allowExtension: true });
...
var DEFAULT_DIR = import_node_path3.default.join(import_node_os.default.homedir(), ".claude", "skills", "teamagent");
...
`);
  ...
  try {
    ...
    void cwd;
    const eventsDbPath = import_node_path4.default.join(import_node_os2.default.homedir(), ".teamagent", "events.db");
    import_node_fs3.default.mkdirSync(import_node_path4.default.dirname(eventsDbPath), { recursive: true });
