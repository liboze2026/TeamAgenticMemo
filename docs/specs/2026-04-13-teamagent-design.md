...
#### 第二层：工程层（Engineering Level）— 做法的坑
...
**示例1: 代码层C1 + objective + avoidance**
```json
{
  "id": "personal-001",
  "scope": {"level": "global"},
  "category": "C", "subcategory": "1",
...
**示例2: 工程层E1 + subjective + avoidance**
```json
{
  "id": "team-015",
  "scope": {"level": "team", "project": "my-saas-app"},
  "category": "E", "subcategory": "1",
...
**示例3: 策略层S3 + objective + practice**
```json
{
  "id": "team-042",
  "scope": {"level": "team", "project": "my-saas-app", "paths": ["src/api/**"]},
  "category": "S", "subcategory": "3",
